...
::: {#table:mat-stats}
  ...
  ------------ ---------- --------------------
    ...
    spa2.mtx      3000     0.1813042222222222
    vem1.mtx      1681     0.0047367771018143
    vem2.mtx      2601     0.003137379066786

  : Dimensioni e densità delle matrici coinvolte.
:::
...
::: {#table:spa1-stats}
       `spa1.mtx`                                                        
  -------------------- --------------- ---------------- ---------------- ------------------------
       **Method**       **Tolerance**   **Time (sec)**   **Iterations**     **Relative error**
  ...
  : Risultati dell'esecuzione degli algoritmi su `spa1.mtx`
:::
...
::: {#table:spa2-stats}
  ...
  : Risultati dell'esecuzione degli algoritmi su `spa2.mtx`
:::
...
::: {#table:vem1-stats}
  ...
  : Risultati dell'esecuzione degli algoritmi su `vem1.mtx`
:::
...
::: {#table:vem2-stats}
  ...
  : Risultati dell'esecuzione degli algoritmi su `vem2.mtx`
:::
